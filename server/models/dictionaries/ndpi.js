...
const NDPIDictionarySchema = new Schema({
  _id                 : { type: String, default: uuid.v4 },

  ndpi                : { type: String, required: true },

  ndpiService         : { type: String, default: '' },
  ndpiCategory        : { type: String, default: '' },
...
const NDPIDictionary = mongoose.model('NDPIDictionary', NDPIDictionarySchema);

export default NDPIDictionary;
